"""Step 6b — period-3 regime with coexisting chaos

delta=0.7, gamma=3.325, omega=2.3: period-3 orbit coexists with a chaotic attractor.
Includes the chaos-dust panel: scalar preserves the strange attractor, additive
collapses it to a period-4 orbit.
