"""Step 9 — same family, 4.5x the data

Same box as Step 8; 128 lambda-screened param sets x 35 ICs = 8.96M pairs, 60k Adam
steps. The scaling scoreboard: what data volume fixes (interpolation, in-box spikes,
a near-margin basin call) and what it cannot (beyond-box extrapolation).
