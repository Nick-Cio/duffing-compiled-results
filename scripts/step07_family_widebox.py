"""Step 7 — parametric family, wide box

Parameters fed to the network. delta in [0.4,0.8], gamma in [0.4,4.2], omega in [1.3,2.6]
(retrospectively ~25% chaotic). 48 LHS param sets x 21 ICs = 2M pairs. Scalar (7-input)
vs additive f(x)+d(xdot,delta)+g(cos wt,sin wt,gamma,omega). Includes Lyapunov-filtered rays.
